...
function App() {
  ...
  // const [displaySelect,setDisplaySelect] = useState('My Bookings');
      ...
      <div className='header-section'>
        ...
        <div className="horizontal-menu">
          ...
          {/* <select>
              ...
              <option value="Upcoming Trips"><button><Link to="/upcomingtrips">Upcoming Trips</Link></button></option>
      ...
      <div className='full-form'>
        ...
        <div className="form">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit"><Link to="/ridersearchpage" state={{place:{selectedPlace}, date: {selectedDate},toOffice:{toOfficeClicked}, fromOffice:{fromOfficeClicked}}} style={{ textDecoration: 'none', color: 'white' }}><FontAwesomeIcon icon={faMagnifyingGlassLocation} size="lg" inverse transform="left-4" />Search</Link></button>
          </form>
        )}
        {activeTab === 'toOffice' && (
          <form onSubmit={handleSubmit}>
